      ...
      @foreach($businessProfiles as $businessProfile_element)
        <article class="table-record">
          <div class="table-record-buttons">
            <div class="edit-button" data-endpoint="{{route('businessProfiles_edit', ["businessProfile" => $businessProfile_element->id])}}">
              <button>
            ...
            <div class="destroy-button"  data-endpoint="{{route('businessProfiles_destroy', ["businessProfile" => $businessProfile_element->id])}}">
              <button>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <div class="table-data">
            <ul>
              <li><span>Nombre Comercial</span>{{$businessProfile_element->commercial_name}}</li>
              <li><span>Email</span>{{$businessProfile_element->email}}</li>
            </ul>
          </div>
        </article>
      @endforeach
...
@section("form")
  <div class="form-buttons">
    <div class="create-button" data-endpoint="{{route('businessProfiles_create')}}">
      <button>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>broom</title><path d="M19.36,2.72L20.78,4.14L15.06,9.85C16.13,11.39 16.28,13.24 15.38,14.44L9.06,8.12C10.26,7.22 12.11,7.37 13.65,8.44L19.36,2.72M5.93,17.57C3.92,15.56 2.69,13.16 2.35,10.92L7.23,8.83L14.67,16.27L12.58,21.15C10.34,20.81 7.94,19.58 5.93,17.57Z" /></svg>
      </button>
    </div>
    <div class="store-button" data-endpoint="{{route('businessProfiles_store')}}">
      <button>
    ...
    <div class="form-row">
      <div class="form-element">
        ...
        <div class="form-element-input">
          <input type="text" name="commercial_name" value="{{$businessProfile->commercial_name ?? ''}}">
        </div>
      </div>
      <div class="form-element">
        <div class="form-element-label">
        ...
        <div class="form-element-input">
          <input type="text" name="email" value="{{$businessProfile->email ?? ''}}">
        </div>
      </div>
  </form>
@endsection
